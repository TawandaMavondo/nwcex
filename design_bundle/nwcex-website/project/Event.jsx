/* global React, Eyebrow, Icon, Btn, GoldFrame, IconChip */

// ---- Featured event with programme (charcoal) ----
function FeaturedEvent({ onBook }) {
  const agenda = [
    ...
    <section id="programme" style={{ background: 'var(--ink-800)', padding: '96px 40px', backgroundColor: "rgb(32, 33, 35)" }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
        <div>
          ...
          <p style={{ fontFamily: 'var(--font-serif)', fontSize: 20, color: 'var(--on-dark-2)', lineHeight: 1.5, marginTop: 18, maxWidth: 460 }}>A full day of keynotes, panels and workshops with the leaders redefining social care followed by an evening gala dinner.
...
Object.assign(window, { FeaturedEvent, NetworkBand });