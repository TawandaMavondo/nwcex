...
import { Eyebrow, Btn, GoldFrame } from './primitives.jsx';
    ...
    <section id="tickets" style={{ background: 'var(--beige-100)', padding: '96px 40px' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 54 }}>
          ...
          <p style={{ fontFamily: 'var(--font-serif)', fontSize: 20, color: 'var(--on-light-2)', margin: '16px auto 0', maxWidth: 560 }}>
            Redefining the Norm · Deansgate Hotel, Manchester · 22 August 2026
          </p>
        </div>
