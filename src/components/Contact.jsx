...
import { Eyebrow, Btn, Logo, GoldFrame } from './primitives.jsx';
    ...
    <section id="contact" style={{ background: 'var(--beige-50)', padding: '100px 40px' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '.9fr 1.1fr', gap: 72, alignItems: 'start' }}>
        <div>
          ...
          <p style={{ fontFamily: 'var(--font-sans)', fontSize: 16, lineHeight: 1.7, color: 'var(--on-light-2)', margin: '20px 0 32px', maxWidth: 380 }}>
            Whether you're attending, speaking, partnering or joining the network — we'd be glad to hear from you.
          </p>
