...
export function Logo({ size = 24, subline = true, light = true }) {
...
export function GoldFrame({ inset = 12, children, style }) {
  return (
...
export function IconChip({ name, label, light }) {
  return (
...
export function PhotoPlaceholder({ label, icon = 'image', ratio = '4/3', radius = 6, style }) {
  return (
    <div style={{
